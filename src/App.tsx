...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#111111] relative overflow-hidden bg-grid-lines">
      ...
      <section 
        id="hero" 
        className="relative min-h-[100vh] pt-24 sm:pt-28 md:pt-32 pb-16 px-6 max-w-7xl mx-auto flex flex-col justify-between"
      >
        
        {/* Massive Name Typography Header in Flow to Prevent Coverage/Overlap */}
        <div className="w-full hidden lg:flex justify-between items-center pointer-events-none select-none z-0 pb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-4 items-start relative z-10">
          ...
          {/* LEFT CONTENT AREA */}
          <div 
            className="lg:col-span-5 flex flex-col justify-center text-left space-y-6 pt-2 lg:pt-4 lg:-mt-12"
          >
            ...
            <div className="pt-2 max-w-sm space-y-4">
              <div>
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer"
                  className="bg-white hover:bg-slate-50 border border-slate-300 py-3.5 px-6 rounded-full text-[13px] font-semibold tracking-tight transition flex items-center justify-between shadow-premium-sm cursor-pointer w-[190px]"
                >
              ...
              <div className="pt-1 select-none">
                <div className="flex flex-wrap gap-2 text-[12px] font-mono font-semibold max-w-md">
          ...
          <div className="lg:col-span-7 select-none relative h-full lg:-mt-[2vw] mt-10 lg:mt-0 z-10 w-full">
            <ShowcaseDesktop />
            <ShowcaseMobile />
          </div>
        ...
        <div 
          className="flex flex-col items-center justify-center pt-10 cursor-pointer text-slate-400 hover:text-black transition select-none mt-6 md:mt-0" 
          onClick={() => scrollTo('projects')}
        >
      ...
      <section 
        id="projects" 
        className="py-20 sm:py-24 px-6 max-w-7xl mx-auto scroll-mt-10 font-sans min-h-[600px]"
      >
        <div className="mb-12 text-left lg:-mt-10">
      ...
      >
        <div className="mb-10 text-left lg:-mt-5">
          <span className="text-[10px] text-blue-600 font-mono font-bold tracking-widest uppercase block mb-1">
      ...
      <section 
        ...
        className="py-20 sm:py-24 px-6 max-w-7xl mx-auto scroll-mt-20 font-sans"
      >
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch lg:-mt-5">
      ...
      >
        <div className="mb-10 text-left lg:-mt-4">
          <span className="text-[10px] text-blue-600 font-mono font-bold tracking-widest uppercase block mb-1">
      ...
      <footer 
        className="bg-slate-950 text-white pt-12 pb-8 px-6 font-sans relative overflow-hidden border-t border-slate-900 min-h-[190px]"
      >
